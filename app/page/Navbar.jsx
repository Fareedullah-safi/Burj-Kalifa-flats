        ...
        <header className="bg-zinc-900 shadow-md">
            <div className="px-6 py-4 flex items-center justify-between w-full">
                <Link href="/" className="flex flex-col items-start leading-tight group">
                    <span className="text-4xl font-bold text-cyan-300 tracking-widest uppercase font-[Cinzel] group-hover:text-cyan-400 transition">
                        Burj Khalifa
                    </span>
                ...
                {/* Desktop Menu */}
                <nav className="hidden md:flex space-x-6 text-gray-100 font-medium items-center">
            ...
            >
                <ul className="flex flex-col space-y-4 text-gray-100 font-medium">
                    <li>
